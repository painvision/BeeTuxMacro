<p align='center'>
<img width="1000" height="822" alt="image" src="https://github.com/user-attachments/assets/0527358b-a983-49cb-9f52-ff3c8015a7d1" />
</p>

НАМ, РУССКОЯЗЫЧНЫМ, НЕ НУЖЕН ПЕНДОССКИЙ MARKDOWN И КРАСИВОЕ ОФОРМЛЕНИЕ

НАСТОЯЩАЯ РУССКАЯ ДУША ЧИТАЕТ ДОКУМЕНТАЦИЮ СПЛОШНЫМ ТЕКСТОМ

BeeTux Макро ☃️

Макроc для Bee Swarm с открытым исходным кодом. Поддерживает любые оболочки на Wayland (не Mutter) 🐧 
